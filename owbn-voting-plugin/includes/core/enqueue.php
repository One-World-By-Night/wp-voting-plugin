...
add_action('admin_enqueue_scripts', 'wpvotingplugin_enqueue_thickbox');
function wpvotingplugin_enqueue_thickbox()
{
    add_thickbox();
}

// Hook into the plugin row meta
add_filter('plugin_row_meta', 'wpvotingplugin_plugin_row_meta', 10, 2);
function wpvotingplugin_plugin_row_meta($links, $file)
{
...
add_action('admin_footer', 'wpvotingplugin_thickbox_content');
function wpvotingplugin_thickbox_content()
{
?>
 ...
 */
function wpvotingplugin_enqueue_assets()
{
...
add_action('wp_enqueue_scripts', 'wpvotingplugin_enqueue_assets', 99);
