...
function personal_dashboard_shortcode()
{
    ...
    if (is_user_logged_in()) {
        ...
        $normalResultData = array_filter($results, function($item) {
            return $item->voting_stage === 'normal';
        });
...
?>
        <div class="owbnVP dashboard-wrapper">
            <div class="staff-dashboard">
                <h1 class="custom-heading">Welcome, <?php echo esc_html($username); ?></h1>
                <!-- Logout form -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($results) {
                                                            foreach ($normalResultData as $row) {
                                                                ...
                                                                echo '<td><a href="' . esc_url(site_url('/owbn-voting-form?id=' . $row->id)) . '" class="edit-icon"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
